 ...
 * @date: 2022/8/5
 */
public class MCModel extends Model implements Build {
    private ProblemContext context;
    private MultiCopyGraph graph;
    private MCVariable var;
    private MCConstraint cons;
    private int resultStatus;
    private long elapsedTime;
    private Solution oldSol;

    public MCModel(ProblemContext context, MultiCopyGraph graph, Solution oldSol) throws GRBException {
        super();
    ...
    public Solution genSol() throws GRBException {
        ...
        for (Map.Entry<Schedule, Integer> entry : changeMap.entrySet()) {
            MCConstraint.changeSol(solution, entry.getKey(), entry.getValue());
        }
